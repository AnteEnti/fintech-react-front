  ...
  calculators: [
    ...
    },
    {
      ...
      pages: [
        ...
        { path: '/calculators/loans/prepayment', type: PageType.CALCULATOR, title: { en: 'Loan Prepayment Calculator', te: 'లోన్ ప్రీపేమెంట్ కాలిక్యులేటర్' }, description: { en: 'See how early repayment can save you a significant amount of interest.', te: 'ముందస్తు చెల్లింపు మీకు ఎంత వడ్డీని ఆదా చేస్తుందో చూడండి.' }, group: { en: 'Loans & Credit', te: 'రుణాలు & క్రెడిట్' }, interlinks: [], componentName: 'LoanPrepaymentCalculator' },
        { path: '/calculators/loans/balance-transfer', type: PageType.CALCULATOR, title: { en: 'Balance Transfer Calculator', te: 'బ్యాలెన్స్ ట్రాన్స్‌ఫర్ కాలిక్యులేటర్' }, description: { en: 'Compare savings when shifting your loan to another lender with a lower interest rate.', te: 'తక్కువ వడ్డీ రేటుతో మీ రుణాన్ని మరో రుణదాతకు మార్చినప్పుడు పొదుపులను పోల్చండి.' }, group: { en: 'Loans & Credit', te: 'రుణాలు & క్రెడిట్' }, interlinks: [], componentName: 'BalanceTransferCalculator' },
        { path: '/calculators/loans/credit-card-interest', type: PageType.CALCULATOR, title: { en: 'Credit Card Interest Calculator', te: 'క్రెడిట్ కార్డ్ వడ్డీ కాలిక్యులేటర్' }, description: { en: 'Understand the cost of rolling over your credit card balances.', te: 'మీ క్రెడిట్ కార్డ్ బ్యాలెన్స్‌లను రోల్ ఓవర్ చేయడం వల్ల అయ్యే ఖర్చును అర్థం చేసుకోండి.' }, group: { en: 'Loans & Credit', te: 'రుణాలు & క్రెడిట్' }, interlinks: [], componentName: 'CreditCardInterestCalculator' },
        { path: '/calculators/loans/education-loan', type: PageType.CALCULATOR, title: { en: 'Education Loan Repayment Calculator', te: 'విద్యా రుణ తిరిగి చెల్లింపు కాలిక్యులేటర్' }, description: { en: 'Plan your EMIs for an education loan, factoring in the moratorium period.', te: 'మారటోరియం కాలాన్ని పరిగణనలోకి తీసుకుని, విద్యా రుణం కోసం మీ EMIలను ప్లాన్ చేసుకోండి.' }, group: { en: 'Loans & Credit', te: 'రుణాలు & క్రెడిట్' }, interlinks: [], componentName: 'EducationLoanRepaymentCalculator' },
        { path: '/calculators/loans/car-lease-vs-loan', type: PageType.CALCULATOR, title: { en: 'Car Lease vs Loan Calculator', te: 'కారు లీజు vs లోన్ కాలిక్యులేటర్' }, description: { en: 'Compare the financial implications of leasing a car versus financing it with a loan.', te: 'కారును లీజుకు తీసుకోవడం మరియు రుణంతో ఫైనాన్సింగ్ చేయడం వల్ల కలిగే ఆర్థిక చిక్కులను పోల్చండి.' }, group: { en: 'Loans & Credit', te: 'రుణాలు & క్రెడిట్' }, interlinks: [], componentName: 'CarLeaseVsLoanCalculator' },
      ],
    },
    {
    ...
    },
    {
        ...
        pages: [
            ...
            { path: '/calculators/planning/savings-goal', type: PageType.CALCULATOR, title: { en: 'Savings Goal Tracker', te: 'పొదుపు లక్ష్య ట్రాకర్' }, description: { en: 'Plan and track your savings for any goal, like a vacation or a new car. Find out how much you need to save monthly.', te: 'విహారయాత్ర లేదా కొత్త కారు వంటి ఏదైనా లక్ష్యం కోసం మీ పొదుపును ప్లాన్ చేయండి మరియు ట్రాక్ చేయండి. మీరు నెలవారీగా ఎంత ఆదా చేయాలో కనుగొనండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [{ path: '/calculators/investment/sip', title: { en: 'SIP Calculator', te: 'SIP కాలిక్యులేటర్' } }], componentName: 'SavingsGoalTracker' },
            ...
            { path: '/calculators/planning/child-education-cost', type: PageType.CALCULATOR, title: { en: 'Child Education Cost Calculator', te: 'పిల్లల విద్యా ఖర్చు కాలిక్యులేటర్' }, description: { en: 'Project the future cost of your child\'s education and plan your investments accordingly.', te: 'మీ పిల్లల విద్య యొక్క భవిష్యత్ వ్యయాన్ని అంచనా వేయండి మరియు దానికి అనుగుణంగా మీ పెట్టుబడులను ప్లాన్ చేసుకోండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [], componentName: 'ChildEducationCostCalculator' },
            { path: '/calculators/planning/vacation-goal', type: PageType.CALCULATOR, title: { en: 'Vacation/Travel Goal Calculator', te: 'విహారయాత్ర/ప్రయాణ లక్ష్య కాలిక్యులేటర్' }, description: { en: 'Calculate the monthly savings needed to fund your dream trip.', te: 'మీ కలల యాత్రకు నిధులు సమకూర్చడానికి అవసరమైన నెలవారీ పొదుపులను లెక్కించండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [], componentName: 'VacationGoalCalculator' },
            { path: '/calculators/planning/net-worth', type: PageType.CALCULATOR, title: { en: 'Net Worth Calculator', te: 'నికర విలువ కాలిక్యులేటర్' }, description: { en: 'Get an overview of your financial health by calculating your assets minus liabilities.', te: 'మీ ఆస్తుల నుండి అప్పులను తీసివేయడం ద్వారా మీ ఆర్థిక ఆరోగ్యం యొక్క అవలోకనాన్ని పొందండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [], componentName: 'NetWorthCalculator' },
            { path: '/calculators/planning/monthly-budget', type: PageType.CALCULATOR, title: { en: 'Monthly Budget Planner', te: 'నెలవారీ బడ్జెట్ ప్లానర్' }, description: { en: 'Track your monthly income versus expenses to manage your finances better.', te: 'మీ ఆర్థిక వ్యవహారాలను మెరుగ్గా నిర్వహించడానికి మీ నెలవారీ ఆదాయం మరియు ఖర్చులను ట్రాక్ చేయండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [], componentName: 'MonthlyBudgetPlanner' },
            { path: '/calculators/planning/inflation-impact', type: PageType.CALCULATOR, title: { en: 'Inflation Impact Calculator', te: 'ద్రవ్యోల్బణ ప్రభావ కాలిక్యులేటర్' }, description: { en: 'Understand the future value erosion of your money due to inflation.', te: 'ద్రవ్యోల్బణం కారణంగా మీ డబ్బు యొక్క భవిష్యత్ విలువ క్షీణతను అర్థం చేసుకోండి.' }, group: { en: 'Personal Finance & Planning', te: 'వ్యక్తిగత ఫైనాన్స్ & ప్రణాళిక' }, interlinks: [], componentName: 'InflationImpactCalculator' },
        ],
    },
    {
        ...
        pages: [
            ...
            { path: '/calculators/business/hourly-rate', type: PageType.CALCULATOR, title: { en: 'Hourly Rate Calculator', te: 'గంట రేటు కాలిక్యులేటర్' }, description: { en: 'Determine your ideal hourly rate as a freelancer based on your income goals and expenses.', te: 'మీ ఆదాయ లక్ష్యాలు మరియు ఖర్చుల ఆధారంగా ఫ్రీలాన్సర్‌గా మీ ఆదర్శ గంట రేటును నిర్ధారించండి.' }, group: { en: 'Business & Freelancers', te: 'వ్యాపారం & ఫ్రీలాన్సర్లు' }, interlinks: [], componentName: 'HourlyRateCalculator' },
            { path: '/calculators/business/profit-margin', type: PageType.CALCULATOR, title: { en: 'Profit Margin Calculator', te: 'లాభ మార్జిన్ కాలిక్యులేటర్' }, description: { en: 'Analyze your business profitability by comparing cost versus selling price.', te: 'వ్యయం మరియు అమ్మకం ధరను పోల్చడం ద్వారా మీ వ్యాపార లాభదాయకతను విశ్లేషించండి.' }, group: { en: 'Business & Freelancers', te: 'వ్యాపారం & ఫ్రీలాన్సర్లు' }, interlinks: [], componentName: 'ProfitMarginCalculator' },
            { path: '/calculators/business/break-even', type: PageType.CALCULATOR, title: { en: 'Break-Even Point Calculator', te: 'బ్రేక్-ఈవెన్ పాయింట్ కాలిక్యులేటర్' }, description: { en: 'Calculate the number of units you need to sell to cover your fixed costs.', te: 'మీ స్థిర ఖర్చులను కవర్ చేయడానికి మీరు అమ్మాల్సిన యూనిట్ల సంఖ్యను లెక్కించండి.' }, group: { en: 'Business & Freelancers', te: 'వ్యాపారం & ఫ్రీలాన్సర్లు' }, interlinks: [], componentName: 'BreakEvenPointCalculator' },
        ],
    }
  ],
  comparisons: [
